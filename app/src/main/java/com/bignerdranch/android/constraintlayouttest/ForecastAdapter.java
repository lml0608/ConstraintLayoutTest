...
import com.bignerdranch.android.constraintlayouttest.utilities.SunshineDateUtils;
import com.bignerdranch.android.constraintlayouttest.utilities.SunshineWeatherUtils;
...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        int weatherId = mCursor.getInt(ForecastFragment.INDEX_WEATHER_CONDITION_ID);
        int weatherImageId;
